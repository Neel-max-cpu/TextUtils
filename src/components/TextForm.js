...
export default function TextForm(props) {
  ...
  return (
    ...
    <div className='container' style={{color : props.mode==='light'?'black':'white'}}>
        ...
        <button className={`btn btn-${props.color === 'rainbow'? 'danger' : `${props.color}`} mx-1`} onClick={handleUpClick}>Convert To Uppercase</button>
        <button className={`btn btn-${props.color === 'rainbow'? 'warning' : `${props.color}`} mx-1`} onClick={handleLoClick}>Convert To Lowercase</button>
        <button className={`btn btn-${props.color === 'rainbow'? 'primary' : `${props.color}`} mx-1`} onClick={handleClClick}>Clear Text</button>
        <button className={`btn btn-${props.color === 'rainbow'? 'warning' : `${props.color}`} mx-1`} onClick={handleAlClick}>aLtErNaTiNg cAsE</button>
        <button className={`btn btn-${props.color === 'rainbow'? 'dark' : `${props.color}`} mx-1`} onClick={handleCpClick}>copy to clipboard</button>
        <button className={`btn btn-${props.color === 'rainbow'? 'primary' : `${props.color}`} mx-1`} onClick={handleSpClick}>Speak</button>
        <button className={`btn btn-${props.color === 'rainbow'? 'danger' : `${props.color}`} mx-1`} onClick={handleExtraSpaces}>Remove Extra Spaces</button>
    ...
    <div className='container my-3' style={{color : props.mode==='light'?'black':'white'}}>
      ...
      <h2>Preview</h2>
      <p style={{color : props.mode==='light'?'grey':'yellow'}}>{text.length>0?text:"Enter something in the text box above to preview it here!"}</p>
    </div>
    </>
  )
}
